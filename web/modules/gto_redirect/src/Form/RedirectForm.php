...
namespace Drupal\gto_redirect\Form;
...
use Drupal\Core\Url;
use Drupal\gto_redirect\Entity\Redirect;
...
class RedirectForm extends ContentEntityForm
{
	...
	{
		/** @var \Drupal\gto_redirect\Entity\Redirect $redirect */
	...
	public function validateForm(array &$form, FormStateInterface $form_state)
	{
		...
		// 		$form_state->setErrorByName('redirect_source', $this->t(
	...
	public function save(array $form, FormStateInterface $form_state)
	{
		...
		$form_state->setRedirect('gto_redirect.list');
	}
}
